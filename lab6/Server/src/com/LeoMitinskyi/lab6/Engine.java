...
public class Engine {
    ...
    public String readAndExecuteCommand(String commandName) throws IOException, JAXBException, ClassNotFoundException {
    ...
    public String run(String[] commands) throws IOException, JAXBException, ClassNotFoundException {
        return readAndExecuteCommands(commands);
    }

    public String readAndExecuteCommands(String[] commands) throws IOException, JAXBException, ClassNotFoundException {
