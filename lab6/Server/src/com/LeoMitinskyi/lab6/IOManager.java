...
import static com.LeoMitinskyi.lab6.IsDigit.*;
...
public class IOManager {
    ...
    public String FriendReader(String question) throws IOException, ClassNotFoundException {
        question = "Введите имя дурга";
        serverLoop.sendMessage(serverLoop.getByteBuffer(),question,serverLoop.getChannel(),serverLoop.getRemoteAddr());
        return serverLoop.receiveMessage(serverLoop.getByteBuffer());
    }
